...
async function buscarCargo() {
    ...
    searchId.focus();
    try {
        const response = await fetch(`${API_BASE_URL}/cargo/api/${id}`);
...
async function salvarOperacao() {
    ...
    try {
        if (operacao === 'incluir') {
            response = await fetch(`${API_BASE_URL}/cargo/api`, {
                method: 'POST',
                headers: {
            ...
            response = await fetch(`${API_BASE_URL}/cargo/api/${currentPersonId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
...
async function carregarCargos() {
    try {
        const rota = `${API_BASE_URL}/cargo/api`;
